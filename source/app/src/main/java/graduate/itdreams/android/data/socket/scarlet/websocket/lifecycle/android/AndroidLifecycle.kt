...
package graduate.itdreams.android.data.socket.scarlet.websocket.lifecycle.android
...
object AndroidLifecycle {
    ...
    ): Pair<LifecycleOwnerResumedLifecycle,Lifecycle>  {
        val rl = LifecycleOwnerResumedLifecycle(lifecycleOwner, LifecycleRegistry(throttleTimeoutMillis))
        return Pair(rl,rl.combineWith(ConnectivityOnLifecycle(application)))
    }
